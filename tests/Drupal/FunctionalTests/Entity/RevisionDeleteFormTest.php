...
class RevisionDeleteFormTest extends BrowserTestBase {
   ...
   */
  public function providerPageTitle() {
    return [
  ...
  public function providerSubmitForm() {
    ...
    $data['not supporting revision log, multiple revisions remaining after delete'] = [
      ['view test entity'],
      'entity_test_rev',
      'view, view all revisions, delete revision',
      3,
    ...
    $data['supporting revision log, multiple revisions remaining after delete'] = [
      [],
      'entity_test_revlog',
      'view, view all revisions, delete revision',
      3,
   ...
   *   Watchdog entries.
   */
  protected function getLogs(string $channel) {
