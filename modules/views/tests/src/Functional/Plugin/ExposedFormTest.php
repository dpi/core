...
class ExposedFormTest extends ViewTestBase {
   ...
   * @var array
   */
  public static $testViews = ['test_exposed_form_buttons', 'test_exposed_block', 'test_exposed_block_render_in_view', 'test_exposed_form_sort_items_per_page', 'test_exposed_form_pager'];
